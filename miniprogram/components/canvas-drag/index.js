...
Component({
    ...
    methods: {
        ...
        draw() {
          ...
          console.log(this.data.bgBorder);
            ...
            if (this.data.bgBorder !== '') {
                this.ctx.drawImage(this.data.bgBorder, 0, 0, this.toPx(this.data.width), this.toPx(this.data.height));
            }
        ...
        changeBgBorder(newBgBorder) {
            if (typeof newBgBorder == 'string') {
                this.data.bgBorder = newBgBorder;
            }
            this.draw();
        },
        clearCanvas() {
